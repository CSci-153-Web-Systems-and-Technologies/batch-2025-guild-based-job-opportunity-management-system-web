...
const mockRankers: RankerCard[] = [
  {
    ...
    points: 3560,
    medal: <Medal className="absolute top-2 right-2 w-6 h-6 text-yellow-400" />
  },
  {
    rank: 2,
    name: "Danius",
    ...
    level: "Beginner Adventurer",
    points: 3560,
    medal: <Medal className="absolute top-2 right-2 w-6 h-6 text-gray-300" />
  },
  {
    rank: 3,
    name: "Danius",
    ...
    level: "Beginner Adventurer",
    points: 3560,
    medal: <Medal className="absolute top-2 right-2 w-6 h-6 text-orange-400" />
  }
]
